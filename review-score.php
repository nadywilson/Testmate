...
$pending_quiz = $conn->query("
    SELECT qs.*, u.name AS user_name, t.name AS topic_name
    FROM quiz_scores qs
...
if ($mock_table_exists) {
    $check_col = $conn->query("SHOW COLUMNS FROM mock_scores LIKE 'status'");
...
<div class="admin-wrap">
    ...
    <div class="main-content">
        ...
        <h2 style="font-size:16px;font-weight:700;margin-bottom:12px;">Topic Quizzes (<?= count($pending_quiz) ?> pending)</h2>
        <?php if (empty($pending_quiz)): ?>
        ...
        <div style="margin-bottom:30px;">
            ...
            <div class="review-card">
                ...
                <div class="review-meta"><?= $secs_left > 0 ? "auto-reveals in {$secs_left}s" : "ready to auto-reveal" ?></div>
        ...
        <h2 style="font-size:16px;font-weight:700;margin-bottom:12px;">Mock Tests (<?= count($pending_mock) ?> pending)</h2>
